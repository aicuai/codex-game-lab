...
- `public/assets/characters/torako-hakase/expressions/torako-expression-sheet-transparent.png`
- `public/assets/characters/torako-hakase/expressions/torako-expression-cheerful.png`
- `public/assets/characters/torako-hakase/expressions/torako-expression-wink.png`
- `public/assets/characters/torako-hakase/expressions/torako-expression-surprised.png`
- `public/assets/characters/torako-hakase/expressions/torako-expression-thinking.png`
...
`public/assets/characters/torako-hakase/preview.html` で確認したところ、次の問題がありました。
...
- 採用状態シート: `public/assets/characters/torako-hakase/torako-adopted-states-idle4-getdown-gameoverdown-256.png`
- walkcycleシート: `public/assets/characters/torako-hakase/torako-walkcycle-4frame-udlr-256.png`
- プレビューHTML: `public/assets/characters/torako-hakase/preview.html`
- 中間プロンプト: `docs/torako-hakase-imagegen-prompts.md`
- スプライト仕様書: `docs/torako-hakase-spritesheet-spec.md`
- メタデータ: `public/assets/characters/torako-hakase/spritesheet.json`
